...
# Players not in any tournament tier (tracked but untiered)
_UNTIERED_PLAYERS = """\
VA PA CASA#1278
ego illusions#pbe
hsk#pbe2
...
def build_player_list() -> list[tuple[str, str]]:
    """Parse all tier lists + untiered, deduplicate (case-insensitive)."""
    all_raw = "\n".join([_TIER1_PLAYERS, _TIER2_PLAYERS, _OPEN_PLAYERS, _UNTIERED_PLAYERS])
